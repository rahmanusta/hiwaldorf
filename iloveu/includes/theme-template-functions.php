...
if ( ! function_exists( 'yt_direction_nav' ) ) {
	...
	function yt_direction_nav( $nav_id = '', $extra_class = 'gray-2-primary' ) {
		...
		<?php elseif ( $wp_query->max_num_pages > 1 && ( is_home() || is_archive() || is_search() ) ) : // navigation links for home, archive, and search pages ?>
			...
			<div class="nav-previous" data-heading="<?php esc_attr( $title_prev );?>"><?php next_posts_link( $icon_prev . '<span class="pager-title">' . $title_prev . '</span>'); ?></div>
			<?php endif; ?>
			<?php if ( get_previous_posts_link() ) : ?>
			<div class="nav-next" data-heading="<?php esc_attr( $title_next );?>"><?php previous_posts_link( $icon_next . '<span class="pager-title">' . $title_next . '</span>' ); ?></div>
			<?php endif; ?>
...
if ( ! function_exists( 'yt_pagination_nav' ) ) {
	function yt_pagination_nav( $class = "gray-2-primary" ) {
		...
		if( has_action( 'yt_pagination_nav' ))
			return;
	?>
	<nav role="navigation" class="<?php esc_attr( $class );?> pagination-nav hidden-print clearfix">
		<h4 class="screen-reader-text hidden"><?php _e( 'Post navigation', 'yeahthemes' ); ?></h4>
		<div class="pull-left">
			<?php
				global $wp_query;
