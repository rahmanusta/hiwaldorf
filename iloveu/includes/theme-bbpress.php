...
if( !function_exists('yt_bbpress_sticky_topic_label')) {
	...
	function yt_bbpress_sticky_topic_label() {
		...
		if(bbp_is_topic_sticky($topic_id)){
			$output_status = '<span class="label '.(bbp_is_topic_super_sticky($topic_id) ? ' label-primary super-sticky bbp-super-sticky-label' : 'sticky label-primary bbp-sticky-label' ).' margin-right-10" title="">'.__('Sticky','yeahthemes').'</span>';
