...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?><?php echo isset( $quote_bg ) ? $quote_bg : '';?>>
	...
	<header class="entry-header article-header margin-bottom-30">
		...
		<h2 class="entry-title secondary-2-primary margin-bottom-15"><a href="<?php echo esc_url( $share_url ); ?>" rel="bookmark" title="<?php echo esc_attr( strip_tags( get_the_title() ) ); ?>"><?php the_title(); ?></a></h2>
